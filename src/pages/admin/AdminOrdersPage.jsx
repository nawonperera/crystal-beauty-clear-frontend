                ...
                <div className="w-full h-full ">
                    ...
                    {modelIsDisplaying && (
                        <div className="fixed bg-[#00000070] w-full h-full top-0 left-0 flex justify-center items-center">
                            <div className="w-[600px] h-[600px] bg-white relative max-h-[600px]">
                                ...
                                <button
                                    className="absolute w-[40px] h-[40px] rounded-full bg-white shadow shadow-black flex justify-center items-center right-[-20px] top-[-20px]"
                                    onClick={() => {
