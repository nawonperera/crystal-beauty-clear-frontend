        ...
        <div className="w-full h-full rounded-lg flex justify-center items-center">
            <div className="w-[500px] h-[500px] rounded-lg shadow-lg flex flex-col items-center">
                ...
                <div className="w-[400px] h-[100px] flex justify-between items-center rounded-lg">
                    <Link to={"/admin/products"} className="bg-red-400 text-white p-[10px] w-[180px] text-center rounded-lg cursor-pointer hover:bg-red-600 ">Cancel</Link>
                    <button onClick={handleSubmit} className="bg-green-500 text-white p-[10px] w-[180px] text-center rounded-lg ml-[10px] cursor-pointer hover:bg-green-600">Edit Product</button>
                </div>
